  ...
  return (
    <SidebarWrapper className={`bg-white ${isSidebarOpen ? "show-sidebar" : ""}`}>
      ...
      <div className='sidebar-content'>
        <h6 className='fs-18'>My Dashboard</h6>
        <ul className='sidebar-category'>
          <li className='sidebar-link-item fw-5'> <Link to="/dashboard/mycourses" onClick={() => closeSidebar()}>
            My Courses
          </Link></li>
          <li className='sidebar-link-item fw-5'>Account</li>
          <li className='sidebar-link-item fw-5'>Contact Us</li>
        </ul>
